...
import org.usfirst.frc3173.IgKnighters2014.subsystems.Elevation;
/**
 *
 */
public class  TiltWithJoysticks extends Command {
    ...
    protected void execute() {
        if(Robot.elevation.encoderResetting==false){
        Robot.elevation.setTiltSpeed(
                OI.removeDrift(
