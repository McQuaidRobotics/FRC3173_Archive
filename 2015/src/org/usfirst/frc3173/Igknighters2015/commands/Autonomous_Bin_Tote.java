 ...
 *
 */
public class Autonomous_Bin_Tote extends CommandGroup {
    
    public  Autonomous_Bin_Tote() {
        // Add Commands here:
    	...
    	addSequential(new AutonomousAcquireBin(false));
    	addSequential(new AutonomousWait(),1);    //let elevation arms get low enough
    	addSequential(new CloseElevationArms());
    	addSequential(new CloseElevationTips());
    	addSequential(new AutonomousWait(),.2);
    	addSequential(new AutonomousElevate(Robot.elevation.HOLD_BIN+20));
    	addSequential(new AutonomousWait(),2);
    	addSequential(new AutonomousAcquireTote(false)); 
    	addSequential(new AutonomousWait(),1);   //let elevation arms get high enough
